...
export const Register = () => {
   ...
   const loginHandler = async (e) => {
      ...
      if(check.username || check.password || check.fullName) {
               ...
               <div className="col-lg-6 offset-lg-3 col-md-8 offset-md-2 col-sm-10 offset-sm-1 col-12">
                  <form onSubmit={loginHandler} className="card border-top border-5 border-primary">
                     <div className="card-header text-center">
                        <h4 className='form-control fw-bold'>Ro'yxatdan o'tish</h4>
                     </div>
                     <div className="card-body">
                        <div className='mb-3'>
                           <label htmlFor="fullName" className='mb-2 fw-bold'>Foydalanuvchi ismi</label>
                           <input 
                              type="text" 
                     ...
                     <div className="card-footer">
                        <button className='btn btn-primary btn-block me-2'>Register</button>
                        <Link to={'/'}>
                           Sizda hisob bormi?
                        </Link>
                     </div>
